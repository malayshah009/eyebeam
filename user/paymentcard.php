...
<form action = "paymentcard.php" method = "post" >
            <div class="modal-body">
                    <p style="margin:5px 0 2px 0;">Cardholder Name :</p>
                    <input type="text" style="width:100%; padding:5px 0;" pattern="[A-Za-z0-20]+" title="Please Enter Valid Cardholder Name" required>
                    <p style="margin:5px 0 2px 0;">Card Number :</p>
                    <input type="text" style="width:100%; padding:5px 0;" name="cardnumber" pattern="[0-9]{12}" title="Please Enter Valid Card Number" required>
                <div style="display:flex;">
                    <div style="margin-right:20px;">
                        <p style="margin:5px 0 2px 0;">Expire Date :</p>
                        <input type="text" style="text-align:center; padding:5px 9px;" placeholder="MM/YY" style="width:110%; padding:5px 0;"   pattern="(?:0[1-9]|1[0-2])/[0-9]{2}" title="Please input vallid expiry date" required>
                    </div>
                    
                    <div>
                        <p style="margin:5px 0 2px 0;">CVV :</p>
                        <input type="password" style="text-align:center; padding:5px 9px;" placeholder="CVV" style="width:110%; padding:5px 0;" pattern="[0-9]{3}" title="Please Enter Valid CVV Number" required>
                    </div>
                </div>
            </div>
