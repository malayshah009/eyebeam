...
<h6 style="margin: 10px 75px;"> <a href="index.php">Home </a> / Kids Collection</h6>
<div class="line"></div>
...
if(isset($_POST['btnFilter'])){
    ...
    $sql ="SELECT * FROM `product` WHERE `for`='Kid' and `shape`='$shape' and `colour`='$colour' and `size`='$size'";
...
<?php 
         ...
         if(isset($_POST['btnFilter'])){
          ...
          $sql ="SELECT * FROM `product` WHERE `for`='Kid' order by rand();";
