...
<div class="container">
        ...
        <input type="text" style="width:100%; padding:5px 0;" placeholder="SBIKIOSK@123" pattern = "^[a-zA-Z0-9.-]{2, 256}@[a-zA-Z][a-zA-Z]{2, 64}$" title = "Please insert Vallid UPI id" name = "upiid" required>
      </div>
