...
<body>
    <h1 class="container-fluid text-center mt-5">Shape list </h1>
						...
						if($result){
							while($row=mysqli_fetch_array($result)){
								echo"<tr class='table-light'>
                                    ...
                                    <button type='submit' name='btndelshape' class='btn btn-danger btndel'>Disable</button>
                                    <input type='text' hidden value = ".$row['sid']. " name = 'delid'>
                                    </form>
                                    </div>
									</tr>";
